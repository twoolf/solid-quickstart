...
<h3>Data Security</h3>
  ...
  <p>At any time, you can elect not to grant access to the use of location data by de-activating the relevant setting within the Daily24 App or your mobile device.</p>

  <p>If you would like to withdraw from the Study, you may do so within the Daily24 App by clicking on the “Delete account" button in your settings page. You also may contact us at www.metaboliccompass.com to withdraw from the Study.</p>
